<template>
  ...
  <the-header />
  <main>
    <intro-section id="home" class="pt-24" />
    <skill-section id="skills" />
    <experience-section id="experience" class="bg-gray/10 dark:bg-gray/5" />
    <blog-section id="blog" />
  </main>
  <the-footer class="bg-gray/10 dark:bg-gray/5" />
